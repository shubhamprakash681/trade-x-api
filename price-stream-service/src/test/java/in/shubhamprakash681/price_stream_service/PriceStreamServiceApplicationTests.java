...
@SpringBootTest(properties = {
		...
		"tradex.prices.generation.enabled=false",
		"spring.datasource.url=jdbc:h2:mem:price_stream_service_test;MODE=PostgreSQL;DB_CLOSE_DELAY=-1",
...
class PriceStreamServiceApplicationTests {
